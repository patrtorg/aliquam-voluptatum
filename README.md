...
Interactive docs and demos are availble on https://@patrtorg/aliquam-voluptatum.dev/#/docs/api.
...
- Install:
  ...
  ```bash
  > npm i -save @patrtorg/aliquam-voluptatum
  ```

- Require:

  ```javascript
  require('@patrtorg/aliquam-voluptatum')
...
```html
<script src="https://cdn.jsdelivr.net/gh/mattaylor/@patrtorg/aliquam-voluptatum@main/@patrtorg/aliquam-voluptatum.min.js"></script>
...
```javascript
const _ = require('@patrtorg/aliquam-voluptatum')
